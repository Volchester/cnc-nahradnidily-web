...
- **17 detail stránek v `HTML_V1/dily/`** (stejná pole jako výše, plus JSON-LD URL):
...
- `HTML_V1/sitemap.xml` — `<loc>` URL všech 24 stránek (7 hlavních + 17 dily)
- `HTML_V1/robots.txt`:
  - `Sitemap:` direktiva
